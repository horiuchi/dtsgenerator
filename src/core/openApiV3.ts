...
export namespace OpenApisV3 {
    ...
    export namespace SchemaJson {
        export namespace Definitions {
            ...
            export type AnysOrExpressions = Record<string, AnyOrExpression>;
            /**
            ...
            export type CallbacksOrReferences = Record<
                string,
                CallbackOrReference
            >;
            /**
            ...
            export type Encodings = Record<string, Encoding>;
            /**
             *
             */
            ...
            export type ExamplesOrReferences = Record<
                string,
                ExampleOrReference
            >;
            export type Expression = Record<string, any>;
            /**
            ...
            export type HeadersOrReferences = Record<string, HeaderOrReference>;
            /**
            ...
            export type LinksOrReferences = Record<string, LinkOrReference>;
            /**
            ...
            export type MediaTypes = Record<string, MediaType>;
            /**
            ...
            export type ParametersOrReferences = Record<
                string,
             ...
             */
            export type Paths = Record<string, PathItemOrReference>;
            /**
            ...
            export type RequestBodiesOrReferences = Record<
                string,
             ...
             */
            export type ResponsesOrReferences = Record<
                string,
                ResponseOrReference
            >;
            export type SchemaOrReference =
                ...
                | Reference;
            export type SchemasOrReferences = Record<string, SchemaOrReference>;
            /**
            ...
            export type SecuritySchemesOrReferences = Record<
                string,
            ...
            export type ServerVariables = Record<string, ServerVariable>;
            /**
